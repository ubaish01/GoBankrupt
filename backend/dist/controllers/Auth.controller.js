...
exports.AuthContollers = {
    ...
    userOnboard: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const balance = parseInt(((_k = (_j = req.body) === null || _j === void 0 ? void 0 : _j.balance) === null || _k === void 0 ? void 0 : _k.worth) || "100000000");
            if (!avatar)
            ...
            yield user.save();
            const _l = user._doc, { password: pwd, otp, otp_sent_count, last_otp_sent, last_login, last_activity } = _l, rest = __rest(_l, ["password", "otp", "otp_sent_count", "last_otp_sent", "last_login", "last_activity"]);
